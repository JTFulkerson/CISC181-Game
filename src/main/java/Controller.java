...
public class Controller {
    ...
    public void carryOutAction(int fromSquareRow, int fromSquareColumn, int toSquareRow, int toSquareColumn, char action) {
        if(action == 'M'){
            ActionMove move = new ActionMove(this.game, fromSquareRow,fromSquareColumn,toSquareRow,toSquareColumn);
            move.performAction();
        } else if (action == 'S') {
            ActionSpawn spawn = new ActionSpawn(this.game, fromSquareRow,fromSquareColumn,toSquareRow,toSquareColumn);
            spawn.performAction();
        } else if (action == 'R') {
            ActionRecruit recruit = new ActionRecruit(this.game, fromSquareRow,fromSquareColumn,toSquareRow,toSquareColumn);
            recruit.performAction();
        } else if (action == 'A') {
            ActionAttack attack = new ActionAttack(this.game, fromSquareRow,fromSquareColumn,toSquareRow,toSquareColumn);
    ...
    public void playGame() {
        while(!this.game.isGameEnded()) {
            ...
            Rules.checkValidAction(this.game, fromSquareRow, fromSquareColumn, toSquareRow, toSquareColumn, actionType);
